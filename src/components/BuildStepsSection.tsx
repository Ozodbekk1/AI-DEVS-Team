...
export function BuildStepsSection() {
  ...
  const tools = [
    { name: "GPT", gradient: "from-green-400 to-emerald-500" },
    { name: "Vision AI", gradient: "from-blue-400 to-indigo-500" },
    { name: "Replicate", gradient: "from-purple-400 to-pink-500" },
    { name: "Next.js API Routes", gradient: "from-orange-400 to-red-500" }
  ];
            ...
            <div className="grid grid-cols-2 gap-4">
              {tools.map((tool, index) => (
                ...
                >
                  ...
                  <span className="relative z-10 drop-shadow-lg">{tool.name}</span>
                </div>
              ))}
            </div>
          </div>
