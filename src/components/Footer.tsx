      ...
      <div className='max-w-7xl mx-auto px-6 relative'>
        <div className='text-center space-y-8'>
          ...
          <div className='space-y-2'>
            <p className='text-gray-300 text-lg'>🏆 AI500 Hackathon 2025</p>
          ...
          <div className='flex justify-center gap-3 pt-4'>
            ...
            <div
              className='w-3 h-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full animate-bounce-slow shadow-lg shadow-purple-500/50'
              style={{ animationDelay: "0.2s" }}></div>
            <div
              className='w-3 h-3 bg-gradient-to-r from-pink-500 to-[#00D1B2] rounded-full animate-bounce-slow shadow-lg shadow-pink-500/50'
          ...
          <p className='text-gray-600 text-sm pt-4'>
            Made with React by{" "}
            <a
              href='https://www.linkedin.com/in/ozodbekw'
              target='_blank'
              rel='noopener noreferrer'>
              <span className='underline'>Ozodbek</span>
            </a>
          </p>
        </div>
      </div>
