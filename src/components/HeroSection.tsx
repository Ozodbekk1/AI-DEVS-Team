        ...
        <div className='grid lg:grid-cols-2 gap-16 items-center'>
          ...
          <div className='space-y-8 animate-fade-in-up'>
            ...
            <p className='text-[#374151] text-xl max-w-xl leading-relaxed'>
              Your personal AI stylist that creates{" "}
              <span className='text-transparent bg-gradient-to-r from-[#4A67FF] to-[#00D1B2] bg-clip-text font-semibold'>
                perfect outfits
              </span>{" "}
              from real store products.
            </p>
            ...
            <div className='relative w-full aspect-square max-w-lg'>
              ...
              <div className='absolute inset-0 flex items-center justify-center'>
                <div className='relative animate-float'>
                  ...
                  <Shirt
                    className='w-52 h-52 text-white drop-shadow-2xl relative z-10 animate-gentle-bounce'
                    strokeWidth={1.5}
                  />
                </div>
              </div>
